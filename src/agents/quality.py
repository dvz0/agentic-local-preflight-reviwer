...
from src.agents.prompts import QUALITY_SYSTEM, user_review_payload
from src.core.llm import get_chat_llm


def run_quality_agent(git_diff: str, rag_context: list[str]) -> dict[str, Any]:
    ...
    return safe_agent_payload("quality", content)
